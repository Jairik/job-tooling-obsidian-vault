// The activity-log content: a read-only view over the local activity log
// (generations, follow-ups, answers, tool calls, errors) — a chronological list
// plus a few recharts summaries. Rendered inside the Settings dialog's Logs page.
// onClear wipes the log; nothing here mutates it otherwise.
...
export function LogsView({ logs, onClear }: Props) {
